defmodule BoutiqueSuggestionsTest do
  ...
  test "generates one pair from one top and one bottom" do
    top = %{item_name: "Long Sleeve T-shirt", price: 19.95, color: "Deep Red", base_color: "red"}
    bottom = %{item_name: "Wonderwall Pants", price: 48.97, color: "French Navy", base_color: "blue"}
  ...
  test "generates all pairs from two top and two bottom" do
    ...
    bottom1 = %{item_name: "Wonderwall Pants", price: 48.97, color: "French Navy", base_color: "blue"}
  ...
  test "accepts keyword list for third argument for options" do
    assert BoutiqueSuggestions.get_combinations([], [], maximum_price: 200.0)
  end
  ...
  test "filter rejects combinations based on combined maximum price" do
    ...
    assert BoutiqueSuggestions.get_combinations([top], [bottom], maximum_price: 100.0) == []
  end
  ...
  test "filter accepts combinations based on combined maximum price" do
    ...
    assert BoutiqueSuggestions.get_combinations([top], [bottom], maximum_price: 200.0) == [
             {top, bottom}
           ]
  end
  ...
  test "putting it all together" do
    ...
    expected = [{top1, bottom1}, {top1, bottom2}, {top2, bottom1}, {top2, bottom2}, {top3, bottom1}]
    assert BoutiqueSuggestions.get_combinations(tops, bottoms) == expected
  end
end
