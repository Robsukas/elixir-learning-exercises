defmodule NeedForSpeedTest do
  ...
  test "print_race prints a race with no cars" do
    race = %NeedForSpeed.Race{title: "Need For Speed 2021", total_distance_in_meters: 350, cars: []}
  ...
  test "print_race prints a race with a red car" do
...
"
  ...
  test "print_race prints a race with a blue car" do
...
"
  ...
  test "print_race prints a race with a green car" do
...
"
  ...
  test "print_race prints a race in progress with many cars" do
